...
@implementation KPBaseTableViewDataSource
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    ...
    } else if(self.sections[(NSUInteger) section].headerTitle.length) {
        return 40;
    } else {
        return 0;
    };
...
- (CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section {
    ...
    } else if(self.sections[(NSUInteger) section].footerTitle.length) {
        return 40;
    } else {
        return 0;
    };
...
- (NSMutableArray<KPDataSourceSection *> *)sections {
    return objc_getAssociatedObject(self,_cmd);
}

- (void)setSections:(NSMutableArray<KPDataSourceSection *> *)sections {
...
@implementation KPSampleTableViewDataSource
