...
//                 forState:UIControlStateNormal];
        ...
        [_btnImg addSubview:imageView];
        imageView.image = [RCDUtilities imageNamed:@"delete_member_tip" ofBundle:@"RongCloud.bundle"];
        ...
        [self.contentView
         addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_btnImg(56)]"
                                                                options:kNilOptions
                                                                metrics:nil
                                                                  views:NSDictionaryOfVariableBindings(_btnImg)]];
        [self.contentView
         addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_btnImg(56)]"
                                                                options:kNilOptions
                                                                metrics:nil
                                                                  views:NSDictionaryOfVariableBindings(_btnImg)]];
        ...
        [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.trailing.equalTo(_btnImg);
            make.top.equalTo(_btnImg);
        }];
    }
    return self;
}
