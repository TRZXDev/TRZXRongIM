...
- (void)viewDidLoad {
    ...
    gpsImg.image=[UIImage RC_BundleImgName:@"RCDSharedLocation_GPS"];
...
- (void)onUserSelected:(RCDUserInfo *)user atIndex:(NSUInteger)index
{
...
- (BOOL)quitButtonPressed {
    ...
    NSArray *array = @[[RCDChooseModel modelWithStr:@"是否结束位置共享" textColor:[UIColor trzx_TextColor] type:ChooseModelTypeLabel],
                       [RCDChooseModel modelWithStr:@"结束" textColor:[UIColor trzx_RedColor]]];
