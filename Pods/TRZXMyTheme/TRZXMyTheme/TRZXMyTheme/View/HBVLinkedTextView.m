...
@property (nonatomic, strong)NSMutableDictionary *linkedTextRangeDictionary;//装可连接的字符串位置的字典
...
//    获取你点击位置的字符index，characterIndex如果是大于0并且小于1，就说明你点击的就是这个字符，没有超出范围，知道了字符的位置，
...
- (void)commonInit
{
    ...
    _linkedTextDefaultFont = [UIFont boldSystemFontOfSize:15];
    _linkedTextHighlightedColor = [UIColor blackColor];
    _linkedTextHighlightedFont = [UIFont boldSystemFontOfSize:15 ];
