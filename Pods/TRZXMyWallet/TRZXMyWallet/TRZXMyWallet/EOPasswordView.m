...
@interface EOPasswordTF : UITextField

@end

@implementation EOPasswordTF
...
@interface EOPasswordBtn : UIButton

@end

@implementation EOPasswordBtn
...
@interface EOPasswordView ()<UITextFieldDelegate>

@property (nonatomic,strong) EOPasswordTF *tf;
...
-(void)setPasswordLength:(NSInteger)passwordLength {
    ...
    if(_passwordLength == 0){ //默认
        ...
        for (NSUInteger i = 0; i< passwordLength; i++) {
            ...
            EOPasswordBtn *btn = [[EOPasswordBtn alloc] init];
            [self addSubview:btn];
        }
        ...
        if(passwordLength > _passwordLength){ //新的更多
            ...
            [self.subviews enumerateObjectsUsingBlock:^(__kindof UIView * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                ...
                if([obj isKindOfClass:[EOPasswordBtn class]]){
