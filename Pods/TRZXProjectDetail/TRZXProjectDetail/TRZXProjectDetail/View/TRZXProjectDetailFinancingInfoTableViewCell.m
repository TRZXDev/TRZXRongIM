...
- (UILabel *)detailLabel
{
    if (!_detailLabel) {
        ...
        _detailLabel.textColor = [UIColor trzx_RedColor];
...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor trzx_colorWithHexString:@"#555555"];
...
- (UIView *)lineView
{
    ...
    lineView.backgroundColor = [UIColor trzx_colorWithHexString:@"#EBEAF1"];
