...
- (void)setModel:(TRZXProjectDetailDataModel *)model indexPath:(NSIndexPath *)indexPath
{
    ...
    CGRect bounds = [leftTitleString boundingRectWithSize:CGSizeMake(0, _leftTitleLabel.height) options:(NSStringDrawingUsesLineFragmentOrigin) attributes:dic context:nil];
